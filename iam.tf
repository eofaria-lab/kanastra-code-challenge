...
resource "aws_iam_role_policy" "codebuild_role_policy" {
  ...
  policy = templatefile("${path.module}/policy_templates/codebuild_role_policy.tpl",
...
resource "aws_iam_role_policy" "codepipeline_policy" {
  ...
  policy = templatefile("${path.module}/policy_templates/codepipeline_role_policy.tpl", {})
}
